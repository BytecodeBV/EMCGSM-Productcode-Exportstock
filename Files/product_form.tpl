        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-links" data-toggle="tab"><?php echo $tab_links; ?></a></li>
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_attribute_tab) && ($hide_attribute_tab==1) )  { ?>
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_option_tab) && ($hide_option_tab==1) )  { ?>
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_recurring_tab) && ($hide_recurring_tab==1) )  { ?>
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_discount_tab) && ($hide_discount_tab==1) )  { ?>
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_special_tab) && ($hide_special_tab==1) )  { ?>
            ...
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_reward_tab) && ($hide_reward_tab==1) )  { ?>
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_design_tab) && ($hide_design_tab==1) )  { ?>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_price) && ($hide_price==1) )  { ?>
					<input type="text" name="price" value="<?php echo $hide_price_default; ?>" placeholder="<?php echo $entry_price; ?>" id="input-price" class="form-control" />
				<?php } else { ?>
              ...
              <div class="form-group">
				...
				<?php if ( ($cfg_hidden_fields) && ($cfg_hidden_fields==1) && ($hide_quantity) && ($hide_quantity==1) )  { ?>
					<input type="text" name="quantity" value="<?php echo $hide_quantity_default; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" />
				<?php } else { ?>
...
//--></script></div>
	            ...
	            <script>
					<?php 
						if ($cfg_hidden_fields==1) {
							if ( (isset($hide_meta_description)) && ($hide_meta_description==1) ) { ?>
								<?php foreach ($languages as $language) { ?>
									$( "#input-meta-description<?php echo $language['language_id']; ?>" ).parent().parent().hide();
								<?php } ?>
							<?php }

							if ( (isset($hide_meta_keywords)) && ($hide_meta_keywords==1) ) { ?>
								<?php foreach ($languages as $language) { ?>
									$( "#input-meta-keyword<?php echo $language['language_id']; ?>" ).parent().parent().hide();
								<?php } ?>
							<?php }

							if ( (isset($hide_product_tag)) && ($hide_product_tag==1) ) { ?>
								<?php foreach ($languages as $language) { ?>
									$( "#input-tag<?php echo $language['language_id']; ?>" ).parent().parent().hide();
								<?php } ?>
							<?php }

							if ( (isset($hide_sku)) && ($hide_sku==1) ) { ?>
								$( "#input-sku" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_upc)) && ($hide_upc==1) ) { ?>
								$( "#input-upc" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_ean)) && ($hide_ean==1) ) { ?>
								$( "#input-ean" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_jan)) && ($hide_jan==1) ) { ?>
								$( "#input-jan" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_isbn)) && ($hide_isbn==1) ) { ?>
								$( "#input-isbn" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_mpn)) && ($hide_mpn==1) ) { ?>
								$( "#input-mpn" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_location)) && ($hide_location==1) ) { ?>
								$( "#input-location" ).parent().parent().hide();
							<?php }
							...
							if ( (isset($hide_tax_class)) && ($hide_tax_class==1) ) { ?>
								$( "#input-tax-class" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_quantity)) && ($hide_quantity==1) ) { ?>
								$( "#input-quantity" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_entry_minimum)) && ($hide_entry_minimum==1) ) { ?>
								$( "#input-minimum" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_subtract)) && ($hide_subtract==1) ) { ?>
								$( "#input-subtract" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_stock_status)) && ($hide_stock_status==1) ) { ?>
								$( "#input-stock-status" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_seo_keyword)) && ($hide_seo_keyword==1) ) { ?>
								$( "#input-keyword" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_date_available)) && ($hide_date_available==1) ) { ?>
								$( "#input-date-available" ).parent().parent().parent().hide();
							<?php }

							if ( (isset($hide_entry_shipping)) && ($hide_entry_shipping==1) ) { ?>
								$("input[name='shipping']").parent().parent().parent().hide();
							<?php }

							if ( (isset($hide_dimension)) && ($hide_dimension==1) ) { ?>
								$( "#input-length" ).parent().parent().parent().parent().hide();
							<?php }

							if ( (isset($hide_length)) && ($hide_length==1) ) { ?>
								$( "#input-length-class" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_weight)) && ($hide_weight==1) ) { ?>
								$( "#input-weight" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_weight_class)) && ($hide_weight_class==1) ) { ?>
								$( "#input-weight-class" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_sort_order)) && ($hide_sort_order==1) ) { ?>
								$( "#input-sort-order" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_manufacturer)) && ($hide_manufacturer==1) ) { ?>
								$( "#input-manufacturer" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_filter)) && ($hide_filter==1) ) { ?>
								$( "#input-filter" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_store)) && ($hide_store==1) ) { ?>
								$("input[name='product_store[]']").parent().parent().parent().parent().parent().hide();
							<?php }

							if ( (isset($hide_download)) && ($hide_download==1) ) { ?>
								$( "#input-download" ).parent().parent().hide();
							<?php }

							if ( (isset($hide_related)) && ($hide_related==1) ) { ?>
								$( "#input-related" ).parent().parent().hide();
							<?php }
						}
